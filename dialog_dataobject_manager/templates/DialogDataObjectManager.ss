<% require css(dialog_dataobject_manager/css/DialogDataObjectManager.css) %>
<div id="$id" class="RequestHandler FormField DataObjectManager $NestedType field" href="$CurrentLink">
	...
	<div class="dataobjectmanager-actions" style="float:left; width: 300px; margin-top: 10px; margin-left: 2px;">		
