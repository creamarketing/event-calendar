...
abstract class UploadifyField extends FormField
{
	...
	public $overrideDeletePermission = false;
	...
	public function deletefile() {
		if(!Permission::check("CMS_ACCESS_CMSMain") && !$this->overrideDeletePermission)
			return;
	...
	/**
	 * Determines whether a user can import existing files
	 *
	 * @return boolean
	 */
	public function CanImportExisting() {
	...
	public function setBackend($mode) {
	...
	public function imagesOnly() {
		$this->imagesOnlySet = true;
		$this->setFileTypes(self::$image_extensions, _t('Uploadify.IMAGES','Images'));
	}
	
	public function IsImagesOnly() {
		return $this->imagesOnlySet;
	}
	 ...
	 * Turns on import
	 */
	public function allowImporting() {
	 ...
	 * Turns off import
	 */
	public function removeImporting() {
